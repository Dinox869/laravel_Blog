    ...
    <div class="h-screen bg-cover" style="background: url('http://bit.ly/2gPLxZ4'); background-repeat: no-repeat; background-size: cover;">
            <nav class="md:flex  md:justify-between md:items-center">
                ...
                <div class ="mt-12 md:mt-0  space-x-5 mr-10">
                    <a href="{{ route('register') }}" class="text-sm text-white font-bold">Register</a>
                ...
                <div class="leading-loose">
                    <form method="POST" action="{{ route('login') }}" class="max-w-sm m-4 p-10 bg-white bg-opacity-25 rounded shadow-xl">
                        ...
                        <div class="">
                            ...
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="email" name="email" id="email" placeholder="" aria-label="email" required>
                            @error('email')
                        ...
                        <div class="mt-2">
                            <label class="block text-sm text-white">Passwords</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-300 rounded focus:outline-none focus:bg-white" type="password" name="password" id="password" placeholder="" aria-label="password" required>
                            @error('password')
                            <span class="text-red-300 text-xs">
                                {{ $message }}
                            </span>
